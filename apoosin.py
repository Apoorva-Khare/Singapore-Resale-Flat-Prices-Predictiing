...
def predict_price(year,town,flat_type,flr_area_sqm,flat_model,stry,re_les_year,
    ...
    user_data = np.array([[year_1,town_2,flt_ty_2,flr_ar_sqm_1,
                           flt_model_2,str,rem_les_year,rem_les_month,
                           lese_coms_dt]])
...
#     st.image(img)
    ...
    with col2:
        ...
        stry= st.selectbox("Select the Storey", ['03', '06', '09', '12', '15', '18', '21', '24', '27', '30', '33',
                                                             '36', '39', '42', '45', '49', '51'])

        #stry_end= st.selectbox("Select the Storey End(Eg. for Storey Start=01,Storey End=03 so on )", [str(i) for i in range(3,53,2)])

        re_les_year= st.number_input("Enter the Value of Remaining Lease Year (Min: 41 / Max: 97)")
    ...
    if button:
        ...
        pre_price= predict_price(year, town, flat_type, flr_area_sqm, flat_model,
                        stry, re_les_year, re_les_month, les_coms_dt)
