...
def predict_price(year,town,flat_type,flr_area_sqm,flat_model,storey,re_les_year,
    ...
    user_data = np.array([[year_1,town_2,flt_ty_2,flr_ar_sqm_1,
                           flt_model_2,stry,rem_les_year,rem_les_month,
                           lese_coms_dt]])
...
if select == "Home":
    img= Image.open(r"C:\Users\Dell\JupyterPythoncodes\singapore.jpg")
    st.image(img)
    ...
    with col2:
        ...
        storey= st.selectbox("Select the Storey", ['03', '06', '09', '12', '15', '18', '21', '24', '27', '30', '33',
                                                             '36', '39', '42', '45', '49', '51'])
    ...
    if button:
        ...
        pre_price= predict_price(year, town, flat_type, flr_area_sqm, flat_model,
                        storey, re_les_year, re_les_month, les_coms_dt)
